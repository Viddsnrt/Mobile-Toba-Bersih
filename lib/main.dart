...
class NotificationProvider extends ChangeNotifier {
  ...
  Future<void> fetchNotifications() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'http://$ipAddress:5000/api/penugasan/notifikasi/user/$userId',
        ),
      );
  ...
  title: Column(
    ...
    children: [
      ...
      body: provider.isLoading
          ? const Center(
              child: CircularProgressIndicator(color: Color(0xFF2D7B3F)),
            )
      ...
      children: [
        Expanded(
          child: _buildStatCard(
            'Total\nLaporan',
            provider.totalLaporan.toString(),
            Icons.assignment,
            Colors.blue,
          ),
        ),
        ...
        Expanded(
          child: _buildStatCard(
            'Diproses',
            provider.laporanDiproses.toString(),
            Icons.sync,
            Colors.orange,
          ),
        ),
        ...
        Expanded(
          child: _buildStatCard(
            'Selesai',
            provider.laporanSelesai.toString(),
            Icons.check_circle,
            Colors.green,
          ),
        ),
